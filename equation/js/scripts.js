...
var c=document.forms[0].c.value;//input gotten from the text field
...
if(isNaN(equation)||isNaN(equation2)){
	...
	//if answer gotten is not a number according to javascript,output no answer
	//else show the answer gotten
}
else{
...
"step 2 : "+ -b +"-&#8730;"+ b*b + -4*a*c +"/"+ 2*a,

"step 3: "+ -b +"-&#8730;"+ (b*b-4*a*c) +"/"+ denom,

"step 4: "+ -b +"-"+ Math.round(numerator*100)/100 +"/"+ denom,

"step 5: "+ Math.round((-b-numerator)*100)/100 +"/"+ denom];//working of second answer
...
{
output.innerHTML="No answer";
$("#hide").hide("4000",function(){location.reload();});
	};
if(!isNaN(equation)&&!isNaN(equation2)){
	showWorking();
